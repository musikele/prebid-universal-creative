...
var domHelper = _interopRequireWildcard(__webpack_require__(4));
...
var postscribe = __webpack_require__(5);
...
var _nativeTrackerManager = __webpack_require__(3);

window.pbNativeTag = window.pbNativeTag || {};
var nativeTrackerManager = (0, _nativeTrackerManager.newNativeTrackerManager)(window);
...
exports.newNativeTrackerManager = newNativeTrackerManager;

var _utils = __webpack_require__(0);

var _nativeAssetManager = __webpack_require__(6);
...
function newNativeTrackerManager(win) {
  ...
  var startTrackers = function startTrackers(dataObject) {
    ...
    sendMessage = (0, _messaging.prebidMessenger)(targetingData.pubUrl, win);
    var nativeAssetManager = (0, _nativeAssetManager.newNativeAssetManager)(window, targetingData.pubUrl);
    ...
    if (targetingData && targetingData.env === 'mobile-app') {
      var cb = function cb() {
        ...
        function loadMobileClickTrackers(clickTrackers) {
          (clickTrackers || []).forEach(_utils.triggerPixel);
        }
        ...
        (impTrackers || []).forEach(_utils.triggerPixel);
      };
...
var _nativeORTBTrackerManager = __webpack_require__(7);
